 ...
 *
 * @version 9.00	2018-04-28 Enhanced double calculator.
 * @version 10.00	2018-10-06 Enhanced double calculator with UNumber Library
 */

public class Calculator extends Application {

	public final static double WINDOW_WIDTH = 1510;
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Sawan");				// Label the stage (a window)
