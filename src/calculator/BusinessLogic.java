	...
	**********************************************************************************************/
	...
	public boolean setOperand1(String value) {
		...
		if (value.length() <= 0) {						// See if the input is empty. If so no error
			...
			// message, but the operand is not defined.
	...
	public boolean setErrorOperand1(String value) {
		operand1Defined = false;							// Assume the operand will not be defined
		if (value.length() <= 0) {						// See if the input is empty. If so no error
...
/** same as above addition(), but here it is processing the values from the method sub() from CalculatorValue Class instead of add().**/
...
/** same as addition(), but here it is processing the values from the method mpy() from CalculatorValue Class instead of add().**/
...
/** same as addition(), but here it is processing the values from the method div() from CalculatorValue Class instead of add().**/
...
/** defined a method of square root assigning on operand 1 using sqrt method from calculator values **/
